...
# We will be attempting to predict if people in the data set belong in a certain class by salary, 
# either making <=50k or >50k per year.
...
# and combine self-employed jobs into a category called self-emp.
